<?php
/**
 * TYPO3 Configuration Array (TCA) for the Blog domain model
 *
...
return [
    'ctrl' => [
        'title' => 'LLL:EXT:' . $languageFile . ':tx_simpleblog_domain_model_blog',
        'label' => 'title',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
    ...
    'columns' => [
        ...
        'title' => [
            'exclude' => false,
            'label' => 'LLL:EXT:' . $languageFile . ':tx_simpleblog_domain_model_blog.title',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim,required'
        ...
        'description' => [
            'exclude' => false,
            'label' => 'LLL:EXT:' . $languageFile . ':tx_simpleblog_domain_model_blog.description',
            'config' => [
                'type' => 'text',
                'cols' => 40,
                'rows' => 15,
        ...
        'image' => [
            'exclude' => false,
            'label' => 'LLL:EXT:' . $languageFile . ':tx_simpleblog_domain_model_blog.image',
        ...
        'posts' => [
            'exclude' => false,
            'label' => 'LLL:EXT:' . $languageFile . ':tx_simpleblog_domain_model_blog.posts',
            'config' => [
                'type' => 'inline',
